...
<header class="site-header">
  <a class="brand" href="{home_path}"><img class="brand-mark" src="{logo_path}" alt="" width="28" height="24"> REUSE Foundation Knowledge Library</a>
</header>
<main class="profile">
{body}
</main>
...
<header class="site-header">
  <div class="brand-block">
    <span class="brand"><img class="brand-mark" src="assets/reuse-logo.png" alt="" width="34" height="29"> REUSE Foundation Knowledge Library</span>
