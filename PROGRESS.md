...
- Full V4 profile complete (markdown + sourced + confidence-rated + schema-v2 CSV row): 156
- Unresearched (no legacy data): ~96
- Partial (legacy data, needs V4 upgrade): ~401
- Has deeper legacy data (still needs V4 sources/confidence/markdown): ~71
